...
<html lang="en">
    ...
    $data=mysqli_query($conn,"Select * from scholarshipcell where rights not in ('Admin','Rejected')");
    ?>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Admin - Manage Scholarship Cell</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="scholarshipcell.php"><i class="fas fa-cog"></i> <span>Scholarship Cell</span></a>
            </li>
        ...
        <div class="dashboard-body">
            <div class="manage-card">
                ...
                <div class="header-controls">
                    <h2>Scholarship Cell Directory</h2>
                ...
                <table class="data-table">
                    ...
                    $counter=1;
                        ...
                        <tr>
                            ...
                            <td><span class="status-badge active"><?php echo $res['rights'];?></span></td>
                            <td class="action-btns">
                                <?php
                                if($res['rights'] == 'New Scholarshipcell'){
                                    ?>
                                    <button class="btn-check" title="Approve Scholarshipcell" onclick="location.href='approve_scholarshipcell.php?id=<?php echo $res['id'];?>'"><i class="fas fa-check"></i></button>
                                    <button class="btn-toggle" style="color: var(--danger-color);" title="Reject Scholarshipcell" onclick="location.href='reject_scholarshipcell.php?id=<?php echo $res['id'];?>'"><i class="fas fa-times"></i></button>
                                    <?php
                                }
                                ?>
                            </td>
