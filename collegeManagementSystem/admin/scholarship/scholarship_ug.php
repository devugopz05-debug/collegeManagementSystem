...
<html lang="en">
    ...
    $data=mysqli_query($conn,"Select * from scholarship_ug where status='Scholarship Cell Approved'");
    ?>
<head>
    <meta charset="UTF-8">
                ...
                <table class="data-table">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <button class="btn-check" title="View Profile" onclick="location.href='approve_ug_scholarship.php?id=<?php echo $res['id'];?>&email=<?php echo $res['email'];?>&path=scholarship_ug.php'"><i class="fas fa-check"></i></button>
