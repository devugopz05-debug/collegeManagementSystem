...
<html lang="en">
    ...
    $data=mysqli_query($conn,"Select * from scholarship_pg where status='Scholarship Cell Approved'");
    ?>
<head>
    <meta charset="UTF-8">
                        ...
                        <tr>
                            ...
                            <td class="action-btns">
                                <button class="btn-view" title="View Profile" onclick="location.href='view_pg_student_scholarship.php?id=<?php echo $res['id'];?>'"><i class="fas fa-eye"></i></button>
                                    <button class="btn-check" title="View Profile" onclick="location.href='approve_pg_scholarship.php?id=<?php echo $res['id'];?>&email=<?php echo $res['email'];?>&path=scholarship_ug.php'"><i class="fas fa-check"></i></button>
