...
<?php
    ...
    $data=mysqli_query($conn,"Select * from facility_bookings");
    ?>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="view_facility_bookings.php"><i class="fas fa-chart-line"></i> <span>Facility Bookings</span></a>
            </li>
            <li class="sidebar-menu-item">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        while($res=mysqli_fetch_array($data)){
                            $hid=$res['hod'];
                            $hdata=mysqli_query($conn,"select * from hod where id='$hid'");
                        ...
                        <tr>
                            ...
                            <td class="action-btns">
                                ...
                                if($res['status']=='Pending'){
                                    ?>
                                    <button class="btn-view" title="Approve Facility" onclick="location.href='approve_facility.php?email=<?php echo $hres['email'];?>&id=<?php echo $res['id'];?>'"><i class="fas fa-check"></i></button>
                                    <button class="btn-cancel" title="Reject Facility" onclick="location.href='reject_facility.php?email=<?php echo $hres['email'];?>&id=<?php echo $res['id'];?>'"><i class="fas fa-times"></i></button>
                                    <?php
                                }
                                ?>
                            </td>
