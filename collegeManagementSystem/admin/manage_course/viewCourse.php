        ...
        <div class="dashboard-body">
            <div class="manage-card">
                ...
                <div class="header-controls">
                    ...
                    <button class="btn-add-course" onclick="location.href='addCourse.php'">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action-btns">
                                <button class="btn-delete" title="Delete Course" onclick="location.href='deleteCourse.php?id=<?php echo $res['id'];?>'"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php
                        }
