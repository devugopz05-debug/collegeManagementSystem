...
<html lang="en">
    ...
    $data=mysqli_query($conn,"Select * from applications where rights='Pending'");
    ?>
<head>
    <meta charset="UTF-8">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="action-btns">
                                <button class="btn-view" title="View Profile" onclick="location.href='view_student.php?id=<?php echo $res['id'];?>'"><i class="fas fa-eye"></i></button>
                                <button class="btn-check" title="Edit Data" onclick="location.href='approve_student.php?id=<?php echo $res['id'];?>'"><i class="fas fa-check"></i></button>
                                <button class="btn-toggle" style="color: var(--danger-color);" title="Reject Application" onclick="location.href='reject_student.php?id=<?php echo $res['id'];?>'"><i class="fas fa-times"></i></button>
                            </td>
                        </tr>
                        <?php
                        }
