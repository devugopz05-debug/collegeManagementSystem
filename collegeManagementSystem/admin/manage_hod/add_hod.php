...
<html lang="en">
    ...
    if(isset($_POST['submit'])){
        ...
        $query=mysqli_query($conn,"insert into hod(name,email,phone,department,password)values('$name','$email','$phone','$dept','$phone')");
        if($query){
            echo "<script>alert('Hod Added');window.location.href='view_hod.php';</script>";
        }else{
            echo "<script>alert('Failed to Add');window.location.href='add_hod.php';</script>";
        }
    }
    ?>
<head>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="view_hod.php"><i class="fas fa-user-check"></i> <span>HOD</span></a>
            </li>
            <li class="sidebar-menu-item">
            ...
            <div class="form-card">
                ...
                <form method="POST">
                    ...
                    <div class="form-field">
                        <input type="text" id="course_name" name="name" placeholder=" " required>
                        <label for="course_name">Name</label>
                    </div>

                    <div class="form-field">
                        <input type="text" id="course_name" name="email" placeholder=" " required>
                        <label for="course_name">Email</label>
                    </div>

                    <div class="form-field">
                        <input type="text" id="course_name" name="phone" placeholder=" " required>
                        <label for="course_name">Phone</label>
                    </div>
