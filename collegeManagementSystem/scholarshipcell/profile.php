...
<?php
    ...
    $data=mysqli_query($conn,"Select * from scholarshipcell where id='$schid'");
    ...
    if(isset($_POST['submit'])){
        ...
        $cpass=$_POST['cpass'];
        if(!$npass){
            $query=mysqli_query($conn,"update scholarshipcell set name='$name',email='$email',phone='$phone'");
            if($query){
            ...
            if($npass == $cpass){
                $query=mysqli_query($conn,"update scholarshipcell set name='$name',email='$email',phone='$phone',password='$cpass'");
                if($query){
                    echo "<script>alert('Profile Updated');window.location.href='profile.php';</script>";
                }else{
                    echo "<script>alert('Failed to Update');window.location.href='profile.php';</script>";
