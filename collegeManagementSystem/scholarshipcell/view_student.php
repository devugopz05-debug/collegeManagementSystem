...
<html lang="en">
    ...
    $data=mysqli_query($conn,"Select * from applications where id='$id'");
            ...
            <li class="sidebar-menu-item" id="scholarship-menu-item">
                ...
                <ul class="sub-menu" id="scholarship-sub-menu">
                    <li class="sub-menu-item">
                        <a href="manages_cholarship/scholarship_ug.php"><i class="fas fa-angle-right"></i> UG Scholarship</a>
                    </li>
                    <li class="sub-menu-item">
                        <a href="manages_cholarship/scholarship_pg.php"><i class="fas fa-angle-right"></i> PG Scholarship</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-menu-item">
            ...
            <div class="profile-card">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-details">
                        <h2><?php echo $res['fname'];?> <?php echo $res['lname'];?> <span style="font-weight: 400; color: #6c757d;"></span></h2>
                ...
                <div class="data-section">
                    ...
                    <div class="data-grid">
                        <div class="data-item">
                            ...
                            <span class="value"><?php echo $res['fname'];?></span>
                        </div>
                        <div class="data-item">
                            <span class="label">Last Name</span>
                            <span class="value"><?php echo $res['lname'];?></span>
                        </div>
                        <div class="data-item">
                ...
                <div class="data-section">
                    <h3><i class="fas fa-graduation-cap"></i> Academic History</h3>
                    <div class="data-grid">
                        <div class="data-item" style="grid-column: span 2;">
                            <span class="label">Previous School/College Name</span>
                            <span class="value"><?php echo $res['previous'];?></span>
                        </div>
                        <div class="data-item">
                            <span class="label">GPA / Percentage</span>
                            <span class="value"><?php echo $res['gpa'];?></span>
                        </div>
                        <div class="data-item">
                            <span class="label">Graduation Date</span>
                            <span class="value"><?php echo $res['gdate'];?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="data-section" style="margin-bottom: 0;">
                    ...
                    <div class="document-links">
                        <a href="../<?php echo $res['certificate10'];?>" target="_blank" title="View 10th Certificate">
                            <i class="fas fa-file-pdf"></i> 10th Certificate
                        </a>
                        <a href="../<?php echo $res['certificate12'];?>" target="_blank" title="View 12th Certificate">
                            <i class="fas fa-file-pdf"></i> 12th Certificate
                        </a>
