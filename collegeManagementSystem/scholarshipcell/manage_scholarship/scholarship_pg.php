...
<html lang="en">
    ...
    $data=mysqli_query($conn,"SELECT * from scholarship_pg ORDER BY CASE WHEN status='Hod Approved' THEN 0 ELSE 1 END, id ASC");
    ?>
<head>
    <meta charset="UTF-8">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="action-btns">
                                <button class="btn-view" title="View Profile" onclick="location.href='view_pg_student_scholarship.php?id=<?php echo $res['id'];?>'"><i class="fas fa-eye"></i></button>
                                <?php if($res['status']=='Hod Approved'){ ?>
                                    <button class="btn-check" title="View Profile" onclick="location.href='approve_pg_scholarship.php?id=<?php echo $res['id'];?>'"><i class="fas fa-check"></i></button>
                                    <button class="btn-toggle" title="View Profile" onclick="location.href='reject_pg_scholarship.php?id=<?php echo $res['id'];?>&email=<?php echo $res['email'];?>&path=scholarship_ug.php'"><i class="fas fa-times"></i></button>
                                <?php
                                }
                                ?>
                            </td>
