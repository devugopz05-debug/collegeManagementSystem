...
<html lang="en">
    ...
    $data=mysqli_query($conn,"Select * from scholarship_pg where id='$id'");
            ...
            <div class="profile-card">
                ...
                <div class="data-section" style="margin-bottom: 0;">
                    ...
                    <div class="document-links">
                        ...
                        <a href="../<?php echo $res['degree_cert'];?>" target="_blank" title="View Semester Certificate">
                            <i class="fas fa-file-pdf"></i> Degree Certificate
                        </a>
